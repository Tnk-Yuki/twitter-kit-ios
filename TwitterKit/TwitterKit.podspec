Pod::Spec.new do |s|
  ...
  s.authors = "Twitter"
  s.platform = :ios, "9.0"
  s.source = { :http => "https://github.com/Tnk-Yuki/twitter-kit-ios/releases/download/3.4.3/TwitterKit.framework.zip", :flatten => true }
  ...
  s.resources = ["Carthage/Build/iOS/TwitterKit.framework/TwitterKitResources.bundle"]
